    ...
    <script>
        $(document).ready(function() {
            ...
            function limpiarTitulos() {
                var elementosTitulos = $('#tituloEstudiantes, #tituloEstadoFinanciero, #tituloRetencion, #tituloEstudiantesNuevos, #tituloTipos, #tituloOperadores, #tituloEstudiantesAntiguos, #tituloProgramas').find("strong");
                var parteEliminar = ': ';
