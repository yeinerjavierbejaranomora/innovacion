...
Route::controller(InformeMoodleController::class)->group(function () {
    ...
    Route::post('/home/Moodle/tablaCursosFacultad', 'tablaCursosFacultad')->middleware('auth')->name('tabla.cursos.facultad');

    Route::post('/home/Moodle/tablaCursosProgramas', 'tablaCursosProgramas')->middleware('auth')->name('tabla.cursos.programa');
...
Route::controller(AlertasTempranasController::class)->group(function(){
    ...
    Route::get('/alertastempranas/coordinador','vistaCoordinador')->middleware('auth')->name('alertas.inicio.coordinador');
