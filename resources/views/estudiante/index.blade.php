                                ...
                                $.each(materiasArray, function(index, materia) {
                                    ...
                                    if (materia.semestre !== currentSemestre) {
                                        ...
                                        const $filaSemestre = 
                                            ...
                                            $('<div class="card card_historial semestre" style="background-color: #dfc14e;color:#4a4848;margin-top: 2%;width: 17%;margin-right: 1%;"><div class="card-body"><h5 style="position: relative;top: 50%;transform: translateY(-50%);text-align: center;"><b>Semestre:</b><br><span id="semestre"> 1'));
